...
def main():
    ...
    maxAmount = 0
    minAmount = 0
    while KEY_WORD == "startrun" and SEVN_STAMP_AMOUNT > 0\
        ...
        if random.randint(0,100) <= 35:
                    prizeStuff.givePrize(numOfDollars,numOfQuaters,numOfDimes,numOfNickle,numOfPennes)
        numOfUser += 1
