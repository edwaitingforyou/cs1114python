...
This program produces a file for each of these periods
that contains the list average percent growth in that period
and also a list of countries with the largest growth,
and those withe the smllest growth (growths can be negative).
...
def writeDataIntoNewFile(largestRate1,largestCountry1,smallestRate1,smallestCountry1,\
                      largestRate2,largestCountry2,smallestRate2,smallestCountry2,\
                      largestRate3,largestCountry3,smallestRate3,smallestCountry3,\
                      averageRate,period):
    '''
    ...
    if period == 1:
         newFileOne = open("1970_1990_summary.txt","w")
         newFileOne.write("1970-1990 Summary Report\naverage growth over all countries: %.3f%%\nThe three ountries with largest growth:\n%s(%.2f%%), %s(%.2f%%), %s(%.2f%%)\nThe three countries with smallest growth:\n%s(%.2f%%), %s(%.2f%%), %s(%.2f%%)"%(averageRate,largestCountry1,largestRate1,largestCountry2,largestRate2,largestCountry3,largestRate3,smallestCountry1,smallestRate1,smallestCountry2,smallestRate2,smallestCountry3,smallestRate3))
         newFileOne.close()
    else:
        newFileTwo = open("1990_2007_summary.txt","w")
